...
func TestGetAccessLogsFiltersAndClears(t *testing.T) {
	...
	filtered := decodeAccessLogsResponse(t, performAccessLogRequest(r, http.MethodGet, "/security/access-logs?ip=198.51.100.7&username=ali&method=GET&path=messages&status=200", "127.0.0.1:1", "test"))
