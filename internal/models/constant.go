...
const (
    ...
    GetAllMessagesFailMessage              = "获取信息失败"
    GetMessageByIDFailMessage              = "获取信息失败"
    MessageNotFoundMessage                 = "信息未找到"
    PostMessageFailMessage                 = "发布信息失败"
    ...
    GetMessagesByPageFailMessage           = "分页获取信息失败"
