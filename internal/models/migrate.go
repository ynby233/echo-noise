...
func MigrateDB(db *gorm.DB) error {
	...
	case "postgres":
		err = db.Set("gorm:table_options", "").
			...
			AutoMigrate(&User{}, &Message{}, &Comment{}, &UserNotification{}, &Setting{}, &SiteConfig{}, &NotifyConfig{}, &MessageLike{}, &UserLifeCountdownConfig{}, &RegistrationApplication{}, &VoceChatContactCache{}, &FriendLink{}, &FriendLinkApply{}, &SecurityAttackLog{}, &SecurityIPBan{}, &SecurityConfig{}, &SecurityLoginAudit{}, &SecurityAccessLog{}, &SecuritySiteVisitLog{})
	case "mysql":
