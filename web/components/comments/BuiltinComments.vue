...
const rootCardClass = computed(() => (isDark.value ? 'rounded-md p-3 bg-[rgba(15,23,42,0.52)] border border-white/10 shadow-[0_16px_32px_rgba(2,6,23,0.52)]' : 'rounded-md p-3 bg-white border border-black/10 shadow-[0_14px_30px_rgba(15,23,42,0.12)]'))
const childCardClass = computed(() => (isDark.value ? 'rounded-md p-2 bg-[rgba(15,23,42,0.52)] border border-white/10 shadow-[0_16px_32px_rgba(2,6,23,0.52)]' : 'rounded-md p-2 bg-white border border-black/10 shadow-[0_14px_30px_rgba(15,23,42,0.12)]'))
