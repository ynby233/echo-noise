...
assert.match(home, /class="sidebar-card mt-2 left-widget-promo-card"/, '桌面广告卡片应有独立紧凑样式钩子')
assert.match(home, /left-widget-promo-card[^}]*padding:\s*6px 14px\s*!important/s, '广告卡片应缩短上下留白并小幅放大图片')
