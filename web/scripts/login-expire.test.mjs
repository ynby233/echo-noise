...
assert.match(component, /普通用户登录过期时间[\s\S]*?受托管理员登录过期时间[\s\S]*?1号管理员默认永不过期/, 'primary-admin UI must name both independent policy panels and its permanent exception')
